/* build: `node build.js modules=text,serialization,interaction,easing,gestures,animation exclude=cufon,itext,parser,image_filters,node,freedrawing,object_straigntening no-svg-export minifier=uglifyjs` */
